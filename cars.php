...
function rowClickHandlerNew(row) {
    ...
    var hotelRow = $(row);
    var hotelInfo = {
        car_id : hotelRow.find("td:eq(0)").text(),
    ...
    localStorage.setItem("carItems", JSON.stringify(hotelInfo));
    showPopup("Car has been added to the cart!", 5000);
    ...
    <div class="centerSection footer-columns">
        ...
        <div class="centerSectionColumn2">
            <div class="formFontStyle foreground">
                <h2>Choose Cars</h2>
                <form id="myForm" action="process_car.php" method='get'>
